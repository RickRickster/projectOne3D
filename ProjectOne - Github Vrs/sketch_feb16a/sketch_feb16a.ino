...
void setup() {
  ...
  projectOne->onMessage(handleMessage); //New!
...
//change to your feed name you created in Adafruit IO
void handleMessage(AdafruitIO_Data *projectOne) { // New!

  Serial.print("received <- ");

//change to your feed name you created in Adafruit IO
  if(projectOne->toPinLevel() == HIGH) // New!
  {Serial.println("HIGH");
...
//change to your feed name you created in Adafruit IO
//  digitalWrite(LED_PIN, projectOne->toPinLevel()); // New!
}
